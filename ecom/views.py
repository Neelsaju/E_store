...
def product_details(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'ecom/product_details.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def product_view(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'ecom/product_list.html',{'products':products,'product_count_in_cart':product_count_in_cart})
